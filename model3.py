...
#        print(t1.shape)
 ...
 #       print(q.size(1))
  ...
  #      print(t0.shape)
   ...
   #     print("t")
    #    print(t.shape)
        slice_s1 = S1.long().expand(config.imsize, config.imsize, config.imsize, 1, config.l_q, q.size(0))
        slice_s1 = slice_s1.permute(5, 4, 3, 2, 1, 0)
        q_out = q.gather(2, slice_s1).squeeze(2)

        slice_s2 = S2.long().expand(config.imsize, config.imsize, 1, config.l_q, q.size(0))
        slice_s2 = slice_s2.permute(4, 3, 2, 1, 0)
